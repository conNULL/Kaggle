...
train_step = tf.train.AdadeltaOptimizer(2).minimize(cross_entropy)
sess = tf.Session()
...
for i in range(30000):
    batch_xs, batch_ys = get_batch(dmat, answers,300)
    ...
    if i % 300 == 0:
        ...
        print('Validation:', accuracy.eval(session = sess, feed_dict={x: batch_xs, y_: batch_ys}))
